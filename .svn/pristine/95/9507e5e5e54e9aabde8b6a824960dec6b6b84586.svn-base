...
/**
 * EmailResponse generated by hbm2java
 */
@Entity
...
public class EmailResponse  implements java.io.Serializable {
    ...
    public EmailResponse(long emailReqNo, String emailStatus, Date effectiveDate) {
        this.emailReqNo = emailReqNo;
        this.emailStatus = emailStatus;
        this.effectiveDate = effectiveDate;
    }
    public EmailResponse(long emailReqNo, String emailStatus, Date effectiveDate, Date endDate) {
       this.emailReqNo = emailReqNo;
       this.emailStatus = emailStatus;
       this.effectiveDate = effectiveDate;
