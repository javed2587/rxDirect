...
//            }
        ...
        function load() {
            ...
            img.addEventListener('click',zoomInOut);
           // $("#btnZoomIn").attr("click","zoomInOut(event)");
           // btn.addEventListener('click',zoomInOut);
            //$("#btnZoomOut").attr("click","zoomInOut(event,0)");
        }
        ...
        var destroy = function (originalProperties) {
            ...
            img.removeEventListener('click',zoomInOut);
