...
public class RepeatRefillReminderMessageThread implements Runnable {
    ...
    private static final Logger logger = Logger.getLogger(RepeatRefillReminderMessageThread.class);
    ...
    public void run() {
        ...
        try {
            ...
            logger.info("Complete SMS Text : " + message);
            ...
            messageRequest.setIsRepeat("Yes");
            ...
            logger.error("Exception->RepeatRefillReminderMessageThread ThreadRun: ", e);
        }
