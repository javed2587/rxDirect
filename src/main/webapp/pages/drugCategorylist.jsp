    ...
    <body>
        ...
        <div id="wrapper">
            <div id="content" class="clearfix">
                ...
                <form:form action="add" commandName="drugCategoriesList">
                                            ...
                                            <c:forEach var="drugCategory" items="${drugCategoriesList}">
                                                ...
                                                <tr class="row grid-row odd">
                                                    <td class="hidden-xs width20-ipad" valign="top">
                                                        <span id="tbl_textalign">${drugCategory.categoryName}</span>
                                                    </td>
                                                    <td class="hidden-xs width20-ipad" valign="top">
                                                        <span id="tbl_textalign">${drugCategory.therapyClassName}</span>
                                                    </td>
                                                    <td class="hidden-xs width20-ipad" valign="top">
                                                        <c:if test="${not empty drugCategory.genericName}">
                                                            <span id="tbl_textalign">${drugCategory.genericName}(${drugCategory.brandName})</span>
                                                        </c:if>
                                                    </td>
                                                     <td class="hidden-xs width20-ipad" valign="top">
                                                        <span id="tbl_textalign">${drugCategory.strength}</span>
                                                    </td>
                                                    <td class="col-lg-1 col-md-1 col-sm-1 col-xs-2 text-right text-left-ipad padd-left-16-ipad">
                                                        <span id="tbl_textalign">
                                                            <a class="${sessionBean.pmap[(11).intValue()].manage eq true?'':'disabled'} " href="${pageContext.request.contextPath}/drugBrand/edit/${drugCategory.brandNameId}"><img src="${pageContext.request.contextPath}/resources/images/edit.jpg" width="20"/></a>&nbsp;
                                                            <a class="${sessionBean.pmap[(11).intValue()].manage eq true?'':'disabled'} "href="${pageContext.request.contextPath}/drugBrand/delete/${drugCategory.brandNameId}" style="text-align:right;"><img src="${pageContext.request.contextPath}/resources/images/delete.jpg" width="20"/></a>
