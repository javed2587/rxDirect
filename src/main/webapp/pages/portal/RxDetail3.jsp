                                        ...
                                        <div class="carousel-inner">
                                            <div class="${not empty order.transferImage?'item active':''}" id="drugImageDiv">
                                                <c:if test="${not empty order.transferImage}"> 
                                                    ...
                                                    <img id="drugImg1" class="drugImg"  src="${order.transferImage}" onclick="zoomin(1, 0);"/>
...
<!--                                                    <input type="image" src="${pageContext.request.contextPath}/resources/images/plus.png" onclick="setZoom('1.75', 'image', 1)"  />
                                        ...
                                        <input id="btnZoomOut" type="image" src="${pageContext.request.contextPath}/resources/images/minus.png" onclick="zoomin(0, 2);" />
                                        <input type="image" src="${pageContext.request.contextPath}/resources/images/rotate.png" id="rotateDrug" class="rotateDrug"/>
                                    </div>
...
<!--                                                            <input type="text" id="pharmacyRxNoFld" value="${order.oldRxNo}" class="form-control set_fld center_fiel bold_new" ${fieldsDisabledFlag} maxlength="9" onkeypress="return IsAlphaNumericWithHyphen(event)" ${ManagePermissionUpdateAllRequestFields}>-->
                                            ...
                                            <div class="table_col_left ${pharmacyClass} col-sm-3">
                                                <div class="rx-col-a"><span>Rx Expires   </span><span class="rx_date" id="rxExpiredDate"><fmt:formatDate value='${order.rxExpiredDate}' pattern='MM-dd-yyyy'/></span></div>
                                            ...
                                            <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="${not empty order.transferImage?'item active':''}" id="drugImageDiv">
                                                        <c:if test="${not empty order.transferImage}"> 
                                                            <div id="dvLoading" class="dvLoading"></div>
                                                            <img id="drugImg"  src="${order.transferImage}" class="drugImg" onclick="zoomin(1, 0);"/>
...
<!--                                                    <input type="image" src="${pageContext.request.contextPath}/resources/images/plus.png" onclick="setZoom('1.75', 'image', 1)"  />
                                    <input type="image" src="${pageContext.request.contextPath}/resources/images/minus.png" onclick="setZoom('0', 'image', 0.26)" />-->
                                        ...
                                        <div id="fillHistory" class="tab-pane fade video_div_two" >
                                            <button type="button" class="btn btn_dtail" id="refillBtn_1" onclick="window.pharmacyNotification.refillSelectedOrders('fillTable_1', 'refillBtn_1')" disabled style="margin-right: 1px;width: 80px;">Add to Refill</button>
                                            <table class="table-striped table table-three" id="fillTable_1">
                                                <thead>
                                                    <tr>
                                                        <th>&nbsp;</th>
                                                        <th>Rx No.</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="row" items="${filledOrdersLst}">   
                                                        <tr id="fillTable_1_tr_"${row.id}>
                                                            <td><input type="checkbox" id="fillTable_1_td_1_"${row.id} name="multirxDCB" value="${row.id}"   onclick="window.pharmacyNotification.controllingActionButtonForRefill('fillTable_1', 'refillBtn_1')"></td>
                                                            <td class=""><a href="${pageContext.request.contextPath}/ConsumerPortal/rxDetail/${row.id}/${patientId}" style="color: blue;float: left;" >${sessionBeanPortal.pharmacyAbbr}-${row.systemGeneratedRxNumber}</a></td>
                                                            <td>
                                                                <fmt:formatDate value='${row.filledDate}' pattern='yyyy-MM-dd' var="date" />
                        ...
                        bind:
                                {
                                    click: function () {
                                        ...
                                        $(".drugImg").rotate({animateTo: value});
                                        $(".drugImg").attr("class", "drugImg drugImg-transform-origin" + value);
                                    }
                                }
                    });
                    /////////////////////////////////////////////////////    
...
//                    var vid = document.getElementById("drugImg");//("videoContainer");
                    ...
                    function zoomin(ops, isBtnClick) {
                        console.log("ops " + ops);
//                            var myImg = vid;
