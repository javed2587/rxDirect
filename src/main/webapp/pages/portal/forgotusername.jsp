...
<html lang="en">
    ...
    <body>
        ...
        <div class="container contentsContainer marginbottom">
            <h2 class="pageTitle">Forgot Username</h2>
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 text-center" style="text-align: center !important;">
                <c:forEach var="pc" items="${pageContents}">
                    ...
                    <c:if test="${fn:containsIgnoreCase(dcTitle, 'Forgot  Username – Content')}">
                        ${pc.content}
                    </c:if>
                </c:forEach>
            </div>
            <form:form action="${pageContext.request.contextPath}/ConsumerPortal/forgotusername" commandName="pharmacy" role="form" method="POST">
