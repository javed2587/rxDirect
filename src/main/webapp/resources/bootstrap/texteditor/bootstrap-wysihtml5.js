!function($, wysi) {
    ...
    var templates = {
        "font-styles": "<li class='editor-dropdown' style='padding-left: 5px; padding-top: 5px;'>" +
                ...
                "</ul>" +
                "</li>",
        "emphasis": "<li style='padding-top: 5px;'>" +
                "<div class='btn-group'>" +
                ...
                "</div>" +
                "</li>",
        "lists": "<li style='padding-top: 5px;'>" +
                "<div class='btn-group'>" +
                ...
                "</div>" +
                "</li>",
        "link": "<li style='padding-top: 5px;'>" +
                "<div class='bootstrap-wysihtml5-insert-link-modal modal fade' style='margin-top:10%; padding-left:36%;padding-right:36%;'>" +
                ...
                "</li>",
        "image": "<li style='padding-top: 5px;'>" +
                "<div class='bootstrap-wysihtml5-insert-image-modal modal fade' style='margin-top:10%; padding-left:36%;padding-right:36%;'>" +
                "<div style='background:white;'>" +
                "<div class='modal-header'>" +
                "<a class='close' data-dismiss='modal'>&times;</a>" +
                "<h3>Insert Image</h3>" +
    ...
    Wysihtml5.prototype = {
        ...
        createToolbar: function(el, options) {
            ...
            var toolbar = $("<ul/>", {
                ...
                'style': "width:100%;position:relative;top:7px;background:#f0eef1;border-left: 1px solid #2071b6;border-right: 1px solid #2071b6;border-top: 1px solid #2071b6;height: 38px;"
            });
