...
public class DeliveryPreferencesController {
    ...
    public ModelAndView loadPage() {
        ModelAndView modelAndView = new ModelAndView("deliverypreferences");
        modelAndView.addObject("deliveryPreferences", setupService.getDeliveryPreferences());
        return modelAndView;
    }
    
    @RequestMapping(value = "/load", method = RequestMethod.POST)
    public ModelAndView save(@ModelAttribute DeliveryPreferences deliveryPreferences, RedirectAttributes redirectAttributes ){
        ModelAndView modelAndView = new ModelAndView("deliverypreferences");
        boolean isSaved = setupService.saveDeliveryPreferences(deliveryPreferences, sessionBean.getUserId());
        if (isSaved){
        ...
        return new ModelAndView("redirect:/delivery/load");
    }
}
